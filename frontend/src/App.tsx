    ...
    <BrowserRouter>
      <div className="min-h-screen flex flex-col">
        ...
        <header className="border-b border-gray-800 bg-gray-900/80 backdrop-blur sticky top-0 z-50">
          <div className="max-w-5xl mx-auto px-3 sm:px-4 py-3 flex items-center gap-3 sm:gap-6">
            <div className="flex items-center gap-2 min-w-0">
              <Film className="text-amber-400 shrink-0" size={22} />
              <span className="font-semibold text-gray-100 text-sm sm:text-base truncate">
                La Sagesse Du Christ
              </span>
              <span className="text-gray-500 text-sm ml-1 hidden sm:inline">— Générateur</span>
            </div>
        ...
        {/* Footer */}
        <footer className="border-t border-gray-800 text-center text-gray-600 text-xs py-3 sm:py-4">
